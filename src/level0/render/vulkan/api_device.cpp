...
std::shared_ptr< IRenderFramebuffer > VulkanDevice::CreateFramebuffer(std::shared_ptr< IRenderPass > renderPass, const std::vector< std::shared_ptr< IRenderImageView > > &images, const RenderExtent2D &extent)
{
	return std::dynamic_pointer_cast< IRenderFramebuffer >(std::make_shared< VulkanFramebuffer >(this, renderPass, images, extent));
}

std::shared_ptr< IRenderFramebuffer > VulkanDevice::CreateFramebuffer(std::shared_ptr< IRenderPass > renderPass, std::shared_ptr< IRenderImageView > image, const RenderExtent2D &extent)
{

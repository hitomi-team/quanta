...
namespace Renderer {
	...
	public:
		...
		bool Setup(RHI *rhi, const Vertex *vertices, unsigned count, MeshType type);
		bool Setup(RHI *rhi, const Vertex *vertices, unsigned vcount, const uint16_t *indices, unsigned icount, MeshType type);
		void Release();
